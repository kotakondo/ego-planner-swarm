...
if __name__ == '__main__':
    ...
    for cd in cd_list:
        ...
        os.system('echo "----------------------------------------------------------------------------------" >> /home/kota/ego_swarm_data/who_died.txt')
        os.system('echo "'+source_bags+'" >> /home/kota/ego_swarm_data/who_died.txt')

        for i in range(len(rosbag)):
        # for i in range(10):
            os.system('echo "'+rosbag[i]+'" >> /home/kota/ego_swarm_data/who_died.txt')
            ...
            for i in range(num_of_agents):
                ...
                try:
                    ...
                    for j in range(len(log.comm_delay)):
                        if log.comm_delay[j] > 2:
                            os.system('echo "drone'+str(i)+'" >> /home/kota/ego_swarm_data/who_died.txt')
                            os.system('echo "comm delay ' + str(j) +'" >> /home/kota/ego_swarm_data/who_died.txt')
